...
html {
        ...
        .button {
  background-color: rgb(98, 115, 226);
  border: none;
  color: white;
  padding: 15px 32px;
  text-align: center;
                        ...
                        <tr>
                            <td class="paddingOuter" valign="top" align="center">
                                <table class="tableWrap" width="640" border="0" align="center" cellpadding="0" cellspacing="0" >
                                    ...
                                    <img class="scaleImg" src="{{asset('/image/4.jpg')}}"  alt="Graph" width="700" height="200" style="display: block;" />
                                    </a>
                                  </span>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <!--Blog heading-->
                                                            <tr>
                                                                <td align="center" valign="top" style="margin: 0; height: 370px; padding-bottom: 2px; font-size:18px ; font-weight: 500; background-color: rgb(98, 115, 226); color: white; font-family: Lato, Helvetica Neue, Helvetica, Arial, sans-serif; line-height: 28px;  mso-line-height-rule: exactly;">
                                                                    <span>
