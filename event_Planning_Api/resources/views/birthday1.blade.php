        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#eee7e7" style="padding: 0; margin: 0;">
            <tr>
                <td align="center" width="700" valign="top">
                    ...
                    <table width="700" border="20" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="padding: 0; margin: 0; ">
                        <tr>
                            <td class="paddingOuter" valign="top" align="center">
                                <table class="tableWrap" width="640" border="0" align="center" cellpadding="0" cellspacing="0" >
                                    ...
                                    <img class="scaleImg" src="{{asset('/image/11.jpg')}}" alt="Graph" width="700" height="250" style="display: block;" />
                                    </a>
                                  </span>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <!--Blog heading-->
                                                            <tr>
                                                                <td align="center" valign="top" style="margin: 0; padding-bottom: 2px; font-size:18px ; font-weight: 500; background-color: rgb(3, 11, 63); height: 370px;">
                                                                    <span>
