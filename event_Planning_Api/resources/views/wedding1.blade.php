                    ...
                    <tr>
                        <td class="paddingOuter" valign="top" align="center">
                            <table class="tableWrap" width="640" border="0" align="center" cellpadding="0" cellspacing="0" >
                                ...
                                <img class="scaleImg" src="{{asset('/image/6.1.jpg')}}"  alt="Graph" width="700" height="300" style="display: block;" />
                                </a>
                              </span>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <!--Blog heading-->
                                                        <tr>
                                                            <td align="center" valign="top" style="margin: 0; padding-bottom: 2px; font-size:18px ; font-weight: 500; background-color:rgb(48, 43, 43);height: 370px;">
                                                                <span>
