                                                        ...
                                                        <tr>
                                                            <td class="fullWidthNM" width="640" align="left" valign="top" style="padding: 0;">
                                                                <table width="100%" align="left" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                    <!--Image section-->
                                                                    <tr>
                                                                        <td align="left" valign="top" style="margin: 0; padding-bottom: 0px; font-size:14px ; font-weight: normal; color:#992323; font-family: Lato, Helvetica Neue, Helvetica, Arial, sans-serif; line-height: 100%;">
                                                                            <span>
                                            <a href="#" style="text-decoration: none; font-style: normal; font-weight: normal;">
                                            <img class="scaleImg" src="{{asset('/image/13.jpg')}}"  alt="Graph" width="700" height="200" style="display: block;" />
                                            </a>
                                          </span>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <!--Blog heading-->
                                                                    <tr>
                                                                        <td align="center" valign="top" style=" background-color: rgb(19, 177, 164) ; height: 370px;">
                                                                            <span>
