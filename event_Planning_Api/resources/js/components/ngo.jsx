  ...
  render() {
    return (
      <div className="contents">
        <img src={ngoMain} alt={joinWork} className="img-fluid myImage" />
          ...
          <Col span={20} offset={2}>
            <div className="text-to-left">
              ...
              <p>
                ...
                repudiandae similique, quia consectetur, et, temporibus modi
                dolorem quasi id fugiat fugit laboriosam optio eveniet
