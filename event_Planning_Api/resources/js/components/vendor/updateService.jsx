...
import { updateService, addImgServices } from "./vendorFunctions";
...
class UpdateService extends Component {
    ...
    componentWillMount() {
        ...
        if (cat == "photographs") {
            this.state.photo["photographer_name"] = data.photographer_name;
            this.state.photo["contact"] = "92" + this.state.photo["contact"];
            this.state.photo["max_pictures"] = this.state.photo["max_pictures"];
        } else if (cat == "venues") {
            this.state.ven["Address"] = data.Address;
            this.state.ven["start_time"] = data.start_time;
            this.state.ven["end_time"] = data.end_time;
        } else if (cat == "car_rental") {
            this.state.car["car_name"] = data.car_name;
            this.state.car["plate_no"] = data.plate_no;
        } else if (cat == "makeup_artists") {
            this.state.make["name"] = data.name;
        } else if (cat == "entertainments") {
            this.state.enter["bandname"] = data.bandname;
            this.state.enter["hours"] = data.hours;
        } else if (cat == "caterings") {
            this.state.cat["start_time"] = data.start_time;
            this.state.cat["end_time"] = data.end_time;
            // var dsh = {};
            // for (var j = 0; j < data.dishes.length; j++) {
            //     this.state.cat["dish" + j] = this.state.cat["dish" + j];
            // }
            this.state.cat["dishes"] = data.dishes;
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                if (cat == "photographs") {
                    ...
                    values["contact"] = "92" + this.state.photo["contact"];
                ...
                updateService(this.props.service.id, values).then(res => {
                    if (res) {
            ...
            <div className="contents">
                ...
                <Row>
                    <Col span={12} offset={3}>
                        <h4 className="text-to-left">Update Service</h4>
                        <br />
                        <Form
                        ...
                        >
                            <Form.Item>
                                {getFieldDecorator("videos", {
                                    initialValue: this.props.service.videos
                                })(
                                    <Input
                                        prefix={
                                            <Icon
                            ...
                            <Form.Item>
                                {getFieldDecorator(
                                    "service_name",
                                    {
                                        initialValue: this.props.service
                                            .service_name
                                    },
                                    {
                                        rules: [
                            ...
                            <Form.Item>
                                {getFieldDecorator(
                                    "price",
                                    {
                                        initialValue: this.props.service.price
                                    },
                                    {
                                        rules: [
                                            {
...
const WrappedUpdateService = Form.create({ name: "normal_login" })(
    UpdateService
);
export default WrappedUpdateService;
